            ...
            if(flagCargoEmpleado)
            {
                ...
                do
                {
                    ...
                    case 1:
                        ...
                        utn_getEntero(&ordenamiento,100,"ingrese uno para ordenar los apellidos de mayor a menor, o 2 para ordenarlos de menor a mayor:","Error.Utilice solos numeros uno y dos.",1,2);
                        system("cls");
